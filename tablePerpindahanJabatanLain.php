...
$tablePerpindahanJabatanLain = showTablePerpindahan("SELECT * FROM tb_perpindahan_jabatan_lain");

if (isset($_POST['verifikasiPerpindahanJabatanLain'])) {
    if (verifikasiPerpindahanJabatanLain($_POST) > 0) {
        echo "<script>
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    document.location.href = 'tablePerpindahanJabatanLain.php';
                }
            })
        });
        </script>
                            ...
                            <div class="modal fade" id="cetakFilter" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="cetakFilterPerpindahanJabatanLain.php" method="get" target="_blank">
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body" id="modal-body">
                                                                <form method="post">
                                                                    ...
                                                                    <button type="submit" class="btn btn-primary col-md-12" name="verifikasiPerpindahanJabatanLain"> Submit</button>
                                                                </form>
                                                            </div>
                                                        </div>
                                                    </div>
