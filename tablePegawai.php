...
$tabelPegawai = query("SELECT * FROM tb_pegawai");
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Database Pegawai</h1>
                    </div>
                    ...
                    <div class="card shadow">
                        <div class="card-header" style="background-color: #fff;">
                            ...
                            <!-- cetak -->
                            <a href="tambahTabelPegawai.php" class="btn-sm btn-success float-right">
                        ...
                        <div class="card-body">
                            <table id="mytable" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    <?php $i = 1; ?>
                                    <?php foreach ($tabelPegawai as $row) : ?>
                                        <tr>
                                            <td><?= $i ?></td>
                                            <td><?= $row['nip']; ?></td>
                                            <td><?= $row['nama']; ?></td>
                                            ...
                                            <td>
                                                ...
                                                <!-- UBAH -->
                                                <a href="editPegawai.php?nip=<?= $row['nip']; ?>" class="btn btn-warning btn-sm mr-1">
                                                    <i class="fa fa-edit"> Edit</i>
                                                </a>

                                                <!-- HAPUS-->
                                                <a href="hapusPegawai.php?nip=<?= $row['nip']; ?>" class="btn btn-danger btn-sm mr-1" onclick="javascript: return confirm('Konfirmasi data akan dihapus');">
