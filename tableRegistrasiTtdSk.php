...
$tableRegistrasiTtdSk = query("SELECT * FROM tb_registrasi_ttd_sk");
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Registrasi TTD SK</h1>
                    </div>
                    ...
                    <div class="card shadow">
                        <div class="card-header" style="background-color: #fff;">
                            ...
                            <!-- tambah data -->
                            <a href="tambahRegistrasiTtdSk.php" class="btn btn-success btn-sm ml-1 float-right">
                            ...
                            <div class="modal fade" id="cetakFilter" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="cetakFilterRegistrasiTtdSk.php" method="get" target="_blank">
                        ...
                        <div class="card-body">
                            <table id="mytable" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    <?php $i = 1; ?>
                                    <?php foreach ($tableRegistrasiTtdSk as $row) : ?>
                                        <tr>
                                            <td><?= $i ?></td>
                                            <td><?= $row['nama']; ?></td>
                                            <td><?= $row['nip']; ?></td>
                                            ...
                                            <td>
                                                ...
                                                <button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#skRegistrasiTtdSk<?= $row['id']; ?>">
                                                    <i class="fa fa-eye"></i> Lihat berkas
                                                </button>

                                                <!-- Modal -->
                                                <div class="modal fade" id="skRegistrasiTtdSk<?= $row['id']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="exampleModalLabel">SK Registrasi <?= $row['nama']; ?></h5>
                                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                    <span aria-hidden="true">&times;</span>
                                                                </button>
                                                            </div>
                                                            <div class="modal-body modal-xl" id="modal-body">
                                                                <div>
                                                                    <iframe src="document/pdf/<?= $row['registrasi_sk']; ?>" frameborder="0" width="470" height="550"></iframe>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <td>
                                                ...
                                                <!-- UBAH -->
                                                <a href="editRegistrasiTtdSk.php?id=<?= $row['id']; ?>" class="btn btn-warning btn-sm mr-1">
                                                    <i class="fa fa-edit"></i> Edit
                                                </a>

                                                <!-- HAPUS-->
                                                <a href="hapusRegistrasiTtdSk.php?id=<?= $row['id']; ?>" class="btn btn-danger btn-sm mr-1" onclick="javascript: return confirm('Konfirmasi data akan dihapus');">
