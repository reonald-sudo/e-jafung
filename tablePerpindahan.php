...
$tablePemberhentian = showTablePerpindahan("SELECT * FROM tb_perpindahan");

if (isset($_POST['verifikasiPerpindahan'])) {
    if (verifikasiPerpindahan($_POST) > 0) {
        echo "<script>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Verifikasi Tabel Perpindahan</h1>
                    </div>
                            ...
                            <div class="modal fade" id="cetakFilter" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="cetakFilterPerpindahan.php" method="get" target="_blank">
                                                                                ...
                                                                                <td>
                                                                                    ...
                                                                                    <div class="modal fade" id="skJafungAkhir<?= $row['id']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                                                        <div class="modal-dialog">
                                                                                            <div class="modal-content">
                                                                                                <div class="modal-header">
                                                                                                    <h5 class="modal-title" id="exampleModalLabel">Sk pangkat <?= $row['nama']; ?></h5>
                                                                                                </div>
                                                                                                <div class="modal-body modal-xl" id="modal-body">
                                                                                                    <div>
                                                                                                        <iframe src="document/pdf/<?= $row['sk_pangkat']; ?>" frameborder="0" width="470" height="520"></iframe>
                                                                                                    </div>
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body" id="modal-body">
                                                                <form method="post">
                                                                    ...
                                                                    <button type="submit" class="btn btn-primary col-md-12" name="verifikasiPerpindahan"> Submit</button>
                                                                </form>
                                                            </div>
                                                        </div>
                                                    </div>
