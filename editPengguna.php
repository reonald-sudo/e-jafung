...
$editPengguna = editData("SELECT * FROM user WHERE id = '$id'");
    ...
    if (gantiPasswordUser($_POST) > 0) {
        echo "<script>
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    document.location.href = 'editPengguna.php?id=$id';
                }
            })
        });
        </script>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">EDIT DATA PENGGUNA E-JAFUNG</h1>
                    </div>
                    ...
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            ...
                            <form action="" method="post">
                                <div class="row">
                                    <input type="hidden" name="id" value="<?= $editPengguna['id']; ?>">
                                    <div class="form-group col-md-4">
                                        <label for="inputPassword4">NIP</label>
                                        <input type="text" class="form-control" id="inputPassword4" required name="nip" value="<?= $editPengguna['nip']; ?>">
                                        <small>NIP PNS</small>
                                    </div>
                                    <div class="form-group col-md-4">
                                ...
                                <button class="btn btn-success float-right" type="submit" name="editPengguna"> Simpan</button>
                            </form>
