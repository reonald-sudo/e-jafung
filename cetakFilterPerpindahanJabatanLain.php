...
$cetakFilterPerpindahan = showCetakFilterPerpindahan("SELECT * FROM " . 'tb_perpindahan_jabatan_lain' . " WHERE " . "tanggal_pengajuan >= " . "'" .  $dariTanggal . "'" . ' AND ' . 'tanggal_pengajuan <= ' . "'" . $sampaiTanggal . "'");
...
<body onload="window.print()">
    ...
    <br>
    <h4 class="tengah hitam">CETAK DATA PENGAJUAN PERPINDAHAN JABATAN FUNGSIONAL LAIN</h4>
    <br>
