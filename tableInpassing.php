...
$tableInpassing = showTableInpassing("SELECT * FROM tb_inpassing");

if (isset($_POST['verifikasiInpassing'])) {
    if (verifikasiInpassing($_POST) > 0) {
        echo "<script>
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    document.location.href = 'tableInpassing.php';
                }
            })
        });
        </script>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Verifikasi Tabel Inpassing</h1>
                    </div>
                    ...
                    <div class="card shadow">
                            ...
                            <div class="modal fade" id="cetakFilter" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="cetakFilterInpassing.php" method="get" target="_blank">
                        ...
                        <div class="card-body">
                            <table id="mytable" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    <?php $i = 1; ?>
                                    <?php foreach ($tableInpassing as $row) : ?>
                                        <tr>
                                            <td><?= $i ?></td>
                                            <td><?= $row['nama']; ?></td>
                                            <td><?= $row['nip']; ?></td>
                                            ...
                                            <td>
                                                ...
                                                <div class="modal fade" id="verifikasi<?= $row['id']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="exampleModalLabel">Verifkiasi Perpindahan <?= $row['nama']; ?></h5>
                                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                    <span aria-hidden="true">&times;</span>
                                                                </button>
                                                            </div>
                                                            <div class="modal-body" id="modal-body">
                                                                <form method="post">
                                                                    ...
                                                                    <button type="submit" class="btn btn-primary col-md-12" name="verifikasiInpassing"> Submit</button>
                                                                </form>
                                                            </div>
                                                        </div>
                                                    </div>
