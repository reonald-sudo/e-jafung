...
$tablePengangkatanKembali = showTablePengangkatanKembali("SELECT * FROM tb_pengangkatan_kembali");

if (isset($_POST['verifikasiPengangkatanKembali'])) {
    if (verifikasiPengangkatanKembali($_POST) > 0) {
        echo "<script>
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    document.location.href = 'tablePengangkatanKembali.php';
                }
            })
        });
        </script>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Verifikasi Tabel Pengangkatan Kembali</h1>
                    </div>
                    ...
                    <div class="card shadow">
                            ...
                            <div class="modal fade" id="cetakFilter" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="cetakFilterPengangkatanKembali.php" method="get" target="_blank">
                        ...
                        <div class="card-body">
                            <table id="mytable" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    <?php $i = 1; ?>
                                    <?php foreach ($tablePengangkatanKembali as $row) : ?>
                                        <tr>
                                            <td><?= $i ?></td>
                                            <td><?= $row['nama']; ?></td>
                                            <td><?= $row['nip']; ?></td>
                                                                    ...
                                                                    <table class="table table-bordered table-hover">
                                                                        ...
                                                                        <tbody>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <!-- Button trigger modal -->
                                                                                    <button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#skPengantar<?= $row['id']; ?>">
                                                                                        <i class="fa fa-eye"></i> Lihat
                                                                                    </button>

                                                                                    <!-- Modal -->
                                                                                    <div class="modal fade" id="skPengantar<?= $row['id']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                                                        <div class="modal-dialog">
                                                                                            <div class="modal-content">
                                                                                                <div class="modal-header">
                                                                                                ...
                                                                                                <div class="modal-body modal-xl" id="modal-body">
                                                                                                    <div>
                                                                                                        <iframe src="document/pdf/<?= $row['sk_pengantar']; ?>" frameborder="0" width="470" height="520"></iframe>
                                                                                                    </div>
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <!-- Button trigger modal -->
                                                                                    <button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#skPembebasan<?= $row['id']; ?>">
                                                                                        <i class="fa fa-eye"></i> Lihat
                                                                                    </button>

                                                                                    <!-- Modal -->
                                                                                    <div class="modal fade" id="skPembebasan<?= $row['id']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                                                        <div class="modal-dialog">
                                                                                            <div class="modal-content">
                                                                                                <div class="modal-header">
                                                                                                    <h5 class="modal-title" id="exampleModalLabel">Sk pembebasan <?= $row['nama']; ?></h5>
                                                                                                </div>
                                                                                                <div class="modal-body modal-xl" id="modal-body">
                                                                                                    <div>
                                                                                                        <iframe src="document/pdf/<?= $row['sk_pembebasan']; ?>" frameborder="0" width="470" height="520"></iframe>
                                                                                                    </div>
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                    ...
                                                                                    <div class="modal fade" id="PakTerakhir<?= $row['id']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                                                        <div class="modal-dialog">
                                                                                            <div class="modal-content">
                                                                                                ...
                                                                                                <div class="modal-body modal-xl" id="modal-body">
                                                                                                    <div>
                                                                                                        <iframe src="document/pdf/<?= $row['pak_terakhir']; ?>" frameborder="0" width="470" height="520"></iframe>
                                                                                                    </div>
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <!-- Button trigger modal -->
                                                                                    <button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#SkPangkatTerakhir<?= $row['id']; ?>">
                                                                                        <i class="fa fa-eye"></i> Lihat
                                                                                    </button>

                                                                                    <!-- Modal -->
                                                                                    <div class="modal fade" id="SkPangkatTerakhir<?= $row['id']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                                                        <div class="modal-dialog">
                                                                                            <div class="modal-content">
                                                                                                <div class="modal-header">
                                                                                                    <h5 class="modal-title" id="exampleModalLabel">Sk Pangkat Terakhir <?= $row['nama']; ?></h5>
                                                                                                </div>
                                                                                                <div class="modal-body modal-xl" id="modal-body">
                                                                                                    <div>
                                                                                                        <iframe src="document/pdf/<?= $row['sk_pangkat_terakhir']; ?>" frameborder="0" width="470" height="520"></iframe>
                                                                                                    </div>
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                ...
                                                                                <td>
                                                                                    ...
                                                                                    <div class="modal fade" id="spmt<?= $row['id']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                                                        <div class="modal-dialog">
                                                                                            <div class="modal-content">
                                                                                                <div class="modal-header">
                                                                                                    <h5 class="modal-title" id="exampleModalLabel">Spmt <?= $row['nama']; ?></h5>
                                                                                                </div>
                                                                                                <div class="modal-body modal-xl" id="modal-body">
                                                                                                    <div>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <!-- Button trigger modal -->
                                                                                    <button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#skMutasi<?= $row['id']; ?>">
                                                                                        <i class="fa fa-eye"></i> Lihat
                                                                                    </button>

                                                                                    <!-- Modal -->
                                                                                    <div class="modal fade" id="skMutasi<?= $row['id']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                                                        <div class="modal-dialog">
                                                                                            <div class="modal-content">
                                                                                                <div class="modal-header">
                                                                                                    <h5 class="modal-title" id="exampleModalLabel">Sk mutasi <?= $row['nama']; ?></h5>
                                                                                                </div>
                                                                                                <div class="modal-body modal-xl" id="modal-body">
                                                                                                    <div>
                                                                                                        <iframe src="document/pdf/<?= $row['sk_mutasi']; ?>" frameborder="0" width="470" height="520"></iframe>
                                                                                                    </div>
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                            ...
                                                                            <!-- SK PEMBERHENTIAN TUBEL -->
                                                                            <tr>
                                                                                <td>Sk pemberhentian tugas belajar</td>

                                                                                <td>
                                                                                    <!-- Button trigger modal -->
                                                                                    <button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#skPemberhentianTubel<?= $row['id']; ?>">
                                                                                        <i class="fa fa-eye"></i> Lihat
                                                                                    </button>

                                                                                    <!-- Modal -->
                                                                                    <div class="modal fade" id="skPemberhentianTubel<?= $row['id']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                                                        <div class="modal-dialog">
                                                                                            <div class="modal-content">
                                                                                                <div class="modal-header">
                                                                                                    <h5 class="modal-title" id="exampleModalLabel">Sk mutasi <?= $row['nama']; ?></h5>
                                                                                                ...
                                                                                                <div class="modal-body modal-xl" id="modal-body">
                                                                                                    <div>
                                                                                                        <iframe src="document/pdf/<?= $row['sk_pemberhentian_tubel']; ?>" frameborder="0" width="470" height="520"></iframe>
                                                                                                    </div>
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                            ...
                                            <td>
                                                ...
                                                <div class="modal fade" id="verifikasi<?= $row['id']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="exampleModalLabel">Verifkiasi Pengangkatan Kembali <?= $row['nama']; ?></h5>
                                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                    <span aria-hidden="true">&times;</span>
                                                                </button>
                                                            </div>
                                                            <div class="modal-body" id="modal-body">
                                                                <form method="post">
                                                                    <!-- id -->
                                                                    <input type="hidden" class="form-control" name="id" id="" value="<?= $row['id']; ?>">
                                                                    ...
                                                                    <button type="submit" class="btn btn-primary col-md-12" name="verifikasiPengangkatanKembali"> Submit</button>
                                                                </form>
                                                            </div>
                                                        </div>
                                                    </div>
