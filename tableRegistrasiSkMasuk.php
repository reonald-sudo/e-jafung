...
$tableRegistrasiSkMasuk = query("SELECT * FROM tb_sk_masuk");
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Registrasi SK Masuk</h1>
                    </div>
                    ...
                    <div class="card shadow">
                        <div class="card-header" style="background-color: #fff;">
                            ...
                            <!-- tambah data -->
                            <a href="tambahRegistrasiSkMasuk.php" class="btn btn-success btn-sm ml-1 float-right">
                            ...
                            <div class="modal fade" id="cetakFilter" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="cetakFilterRegistrasiSkMasuk.php" method="get" target="_blank">
                        ...
                        <div class="card-body">
                            <table id="mytable" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    <?php $i = 1; ?>
                                    <?php foreach ($tableRegistrasiSkMasuk as $row) : ?>
                                        <tr>
                                            <td><?= $i ?></td>
                                            <td><?= $row['nama']; ?></td>
                                            <td><?= $row['nip']; ?></td>
                                            ...
                                            <td>
                                                ...
                                                <!-- UBAH -->
                                                <a href="editRegistrasiSkMasuk.php?id=<?= $row['id']; ?>" class="btn btn-warning btn-sm mr-1">
                                                    <i class="fa fa-edit"></i> Edit
                                                </a>

                                                <!-- HAPUS-->
                                                <a href="hapusRegistrasiSkMasuk.php?id=<?= $row['id']; ?>" class="btn btn-danger btn-sm mr-1" onclick="javascript: return confirm('Konfirmasi data akan dihapus');">
