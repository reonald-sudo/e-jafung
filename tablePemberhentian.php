...
$tablePemberhentian = showTablePemberhentian("SELECT * FROM tb_pemberhentian");

if (isset($_POST['verifikasiPemberhentian'])) {
    if (verifikasiPemberhentian($_POST) > 0) {
        echo "<script>
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    document.location.href = 'tablePemberhentian.php';
                }
            })
        });
        </script>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Verifikasi Tabel Pemberhentian</h1>
                    </div>
                            ...
                            <div class="modal fade" id="cetakFilter" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="cetakFilterPemberhentian.php" method="get" target="_blank">
                                            ...
                                            <td>
                                                ...
                                                <div class="modal fade" id="verifikasi<?= $row['id']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="exampleModalLabel">Verifkiasi Pemberhentian <?= $row['nama']; ?></h5>
                                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                    <span aria-hidden="true">&times;</span>
                                                                </button>
                                                            </div>
                                                            <div class="modal-body" id="modal-body">
                                                                <form method="post">
                                                                    ...
                                                                    <button type="submit" class="btn btn-primary col-md-12" name="verifikasiPemberhentian"> Submit</button>
                                                                </form>
                                                            </div>
                                                        </div>
                                                    </div>
