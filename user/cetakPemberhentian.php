...
$cetakPemberhentian = editData("SELECT * FROM tb_pemberhentian WHERE id = '$id'");
    ...
    <table width="100%" class="container hitam newRoman mb-3">
        <tr>
            <td class="tengah ">
                ...
                <h3 style="padding-top: 5px; padding-bottom: 5px;"><b>PEMBERHENTIAN JABATAN FUNGSIONAL</b></h3>
        ...
        <tbody>
            <tr>
                ...
                <td style="width: 78.4907%;">
                    <h4> Bahwa sebagai pelaksanaan dari Peraturan Menteri Pendayagunaan Aparatur Negara Nomor 01/PER/M.PAN/1/2008 dipandang perlu untuk mengangkat saudara <?= $cetakPemberhentian['nama']; ?>.</h4>
                </td>
            </tr>
            <tr>
                <td style="width: 15.7487%;"><strong>
                ...
                <td style="width: 78.8296%;">
                    ...
                    <h4>
                        <ol style="list-style-type: lower-alpha;">
                            <li>
                                <h4>Nama &nbsp; &nbsp; &nbsp; &nbsp;: <?= $cetakPemberhentian['nama']; ?></h4>
                            </li>
                            <li>
                                <h4>NIP &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; : <?= $cetakPemberhentian['nip']; ?></h4>
                            </li>
                            <li>
                                <h4>Golongan : <?= $cetakPemberhentian['golongan']; ?></h4>
                            </li>
                        </ol>
                    </h4>
                </td>
