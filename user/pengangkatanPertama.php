        ...
        echo "<script>
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    document.location.href = 'pengangkatanPertama.php';
                }
            })
        });
        </script>
...
if (isset($_POST['pengangkatanPertama'])) {
    if (tambahPengangkatanPertama($_POST, $_FILES) > 0) {
        echo "<script>
        $(document).ready(function(){
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Pengusulan pengangkatan pertama jabatan fungsional</h1>
                    </div>
                        ...
                        <form method="post" class="col-12 mt-3 shadow p-3 rounded" enctype="multipart/form-data">
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" class="form-control nip" id="nip" name="nip" required onkeyup="autoFillNip()">
                                    <small style="color: red;">* Masukkan NIP Anda</small>
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="inputEmail4">Nama</label>
                                    <input type="text" class="form-control nama" id="nama" name="nama" required readonly>
                                    <small>Beserta Gelar</small>
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="inputPassword4">Golongan</label>
                                    <!-- <input type="text" class="form-control golongan" id="golongan" required name="golongan" readonly> -->
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="inputEmail4" name="noIjazah" required>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="hidden" class="form-control" id="inputPassword4" value="sedang proses" name="status">
                            </div>

                            <div class="form-group">
                                <label for="inputPassword4">Tanggal Pengajuan</label>
                                <input type="date" class="form-control" id="inputPassword4" name="tanggalPengajuan" required>
                            </div>
                            ...
                            <button type="submit" name="pengangkatanPertama" class="btn btn-primary mr-2"><i class="fas fa-share-square"></i> Ajukan</button>
