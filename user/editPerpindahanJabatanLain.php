...
if (isset($_POST['editPerpindahanJabatanLain'])) {
    if (editPerpindahanJabatanLain($_POST, $_FILES) > 0) {
        echo "<script>
            $(document).ready(function(){
...
$editDataPerpindahanJabatanLain = editData("SELECT * FROM tb_perpindahan_jabatan_lain WHERE id = '$id'");
                        ...
                        <form method="post" class="col-12 mt-3 shadow p-3 rounded" enctype="multipart/form-data">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="inputAddress2" name="noIjazah" value="<?= $editDataPerpindahanJabatanLain['no_ijazah']; ?>">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="inputPassword4" value="<?= $editDataPerpindahanJabatanLain['tanggal_pengajuan']; ?>" name="tanggalPengajuan" readonly>
                            </div>
                            ...
                            <button type="submit" name="editPerpindahanJabatanLain" class="btn btn-primary mr-2"><i class="fas fa-share-square"></i> Ajukan</button>
