        ...
        echo "<script>
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    document.location.href = 'editPemberhentian.php?id=$id';
                }
            })
        });
        </script>
...
if (isset($_POST['editPemberhentian'])) {
    if (editPemberhentian($_POST, $_FILES) > 0) {
        echo "<script>
        $(document).ready(function(){
...
$editDataPemberhentian = editData("SELECT * FROM tb_pemberhentian WHERE id = '$id'");
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Edit data <?= $editDataPemberhentian['nama']; ?> pemberhentian jabatan fungsional</h1>
                    </div>

                    <div class="card mb-3">
                        <form method="post" class="col-12 mt-3 shadow p-3 rounded" enctype="multipart/form-data">
                            <div class="form-row">
                                <input type="hidden" name="id" value="<?= $editDataPemberhentian['id']; ?>">
                                <div class="form-group col-md-4">
                                    <label for="inputPassword4">NIP</label>
                                    <input type="text" class="form-control nip" id="nip" name="nip" required value="<?= $editDataPemberhentian['nip']; ?>" onkeyup="autoFillNip()">
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="inputEmail4">Nama</label>
                                    <input type="text" class="form-control nama" id="nama" name="nama" required value="<?= $editDataPemberhentian['nama']; ?>" readonly>
                            ...
                            <div class="form-group">
                                <label for="inputAddress">Surat Pengantar</label>
                                <input type="file" class="form-control" id="inputAddress" placeholder="1234 Main St" name="skPengantar">
                                <small>File dalam bentuk .pdf</small>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label for="inputAddress">SK PNS</label>
                                    <input type="file" class="form-control" id="inputAddress" name="skPns" required>
                                    <small>File dalam bentuk .pdf</small>
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="inputAddress2">SK CPNS</label>
                                    <input type="file" class="form-control" id="inputAddress2" name="skCpns" required>
                                    <small>File dalam bentuk .pdf</small>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputAddress">SK Jabatan Fungsional Akhir</label>
                                <input type="file" class="form-control" id="inputAddress" placeholder="1234 Main St" name="skJafungAkhir">
                                <small>File dalam bentuk .pdf</small>
                            </div>
                            <div class="form-group">
                                <label for="inputAddress">PAK Terakhir</label>
                                <input type="file" class="form-control" id="inputAddress" placeholder="1234 Main St" name="pakTerakhir">
                                <small>File dalam bentuk .pdf</small>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label for="inputAddress">Surat sakit / Surat cuti diluar tanggungan negara / surat tugas belajar</label>
                                    <input type="file" class="form-control" id="inputAddress" placeholder="1234 Main St" name="suratSakit">
                                    <small>File dalam bentuk .pdf</small>
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="inputAddress">Surat Melaksanakan Tugas Diluar Tupoksi</label>
                                    <input type="file" class="form-control" id="inputAddress" placeholder="1234 Main St" name="skTugasDiluarTupoksi">
                                    <small>File dalam bentuk .pdf</small>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="inputAddress2">SK Pemberhentian Sementara Dari PNS</label>
                                <input type="file" class="form-control" id="inputAddress2" placeholder="Apartment, studio, or floor" name="skPemberhentianSementaraPns">
                                <small>File dalam bentuk .pdf</small>
                            </div>
                            <div class="form-group">
                                <label for="inputAddress2">Surat SKPD Mengenai Ketidak Sanggupan Mengumpulkan Angka Kredit</label>
                                <input type="file" class="form-control" id="inputAddress2" placeholder="Apartment, studio, or floor" name="skpdAngkaKredit">
                                <small>File dalam bentuk .pdf</small>
                            </div>
                            <div class="form-group">
                                <label style="display: none;" for="inputPassword4">Status</label>
                                <input type="text" class="form-control" id="inputPassword4" value="<?= $editDataPemberhentian['status']; ?>" name="status" readonly>
                            </div>

                            <div class="form-group">
                                <label for="inputPassword4">Tanggal Pengajuan</label>
                                <input type="date" class="form-control" id="inputPassword4" value="<?= $editDataPemberhentian['tanggal_pengajuan']; ?>" name="tanggalPengajuan">
                            </div>
                            ...
                            <button type="submit" name="editPemberhentian" class="btn btn-primary mr-2 "><i class="fas fa-edit"></i> Ajukan</button>
