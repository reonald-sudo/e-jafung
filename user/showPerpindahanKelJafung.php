...
$tablePerpindahanKelJafung = showTablePerpindahan("SELECT * FROM tb_perpindahan_kelompok_jafung WHERE nip = '$nip'");
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Cek status pengajuan perpindahan antar kelompok jabatan fungsional</h1>
                    </div>
                    ...
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            <table id="mytable" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    <?php $i = 1; ?>
                                    <?php foreach ($tablePerpindahanKelJafung as $row) : ?>
                                        <tr>
                                            <td><?= $i ?></td>
                                            <td><?= $row['nama']; ?></td>
                                            <td><?= $row['nip']; ?></td>
                                                                                    ...
                                                                                    <div class="modal fade" id="skjafungakhir<?= $row['id']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                                                        <div class="modal-dialog">
                                                                                            <div class="modal-content">
                                                                                                ...
                                                                                                <div class="modal-body modal-xl" id="modal-body">
                                                                                                    <div>
                                                                                                        <iframe src="../document/pdf/<?= $row['sk_jabatan_fungsional_akhir']; ?>" frameborder="0" width="470" height="520"></iframe>
                                                                                                    </div>
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                            ...
                                            <td>
                                                <!-- edit -->
                                                <a href="editPerpindahanKelJafung.php?id=<?= $row['id']; ?>" class="btn-sm btn-warning mr-2">
                                                ...
                                                ?>
                                                    <!-- cetak -->
                                                    <a href="cetakPerpindahanKelJafung.php?id=<?= $row['id']; ?>" class="btn-sm btn-info mr-2">
                                                ...
                                                ?>
                                                <!-- hapus -->
                                                <a href="hapusPerpindahanKelJafung.php?id=<?= $row['id']; ?>" class="btn-sm btn-danger" onclick="javascript: return confirm('Konfirmasi data akan dihapus');">
