        ...
        echo "<script>
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    document.location.href = 'pemberhentian.php';
                }
            })
        });
        </script>
...
if (isset($_POST['pemberhentian'])) {
    if (tambahPemberhentian($_POST, $_FILES) > 0) {
        echo "<script>
            $(document).ready(function(){
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Pemberhentian Jabatan Fungsional</h1>
                    </div>
                        ...
                        <form method="post" class="col-12 mt-3 shadow p-3 rounded" enctype="multipart/form-data">
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" class="form-control nip" id="nip" required name="nip" onkeyup="autoFillNip()">
                                    <small style="color: red;">* Isi sesuai nip anda</small>
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="inputEmail4">Nama</label>
                                    <input type="text" class="form-control nama" id="nama" required name="nama" readonly>
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="inputPassword4" name="tanggalPengajuan">
                            </div>
                            ...
                            <button type="submit" name="pemberhentian" class="btn btn-primary mr-2"><i class="fas fa-share-square"></i> Ajukan</button>
