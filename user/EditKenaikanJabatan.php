        ...
        echo "<script>
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    document.location.href = 'EditKenaikanJabatan.php?id=$id';
                }
            })
        });
        </script>
...
if (isset($_POST['editkenaikanJabatan'])) {
    if (editKenaikanJabatan($_POST, $_FILES) > 0) {
        echo "<script>
        $(document).ready(function(){
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                document.location.href = 'showKenaikanJabatan.php';
            }
        })
    });
    </script>";
...
$editDataKenaikanJabatan = editData("SELECT * FROM tb_kenaikan_jabatan WHERE id = '$id'");
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Edit data <?= $editDataKenaikanJabatan['nama']; ?> kenaikan jabatan fungsional</h1>
                    </div>

                    <div class="card mb-3">
                        <form method="post" class="col-12 mt-3 shadow p-3 rounded" enctype="multipart/form-data">
                            <div class="form-row">
                                <input type="hidden" name="id" value="<?= $editDataKenaikanJabatan['id']; ?>">
                                <div class="form-group col-md-4">
                                    <label for="inputPassword4">NIP</label>
                                    <input type="text" class="form-control nip" id="nip" required name="nip" onkeyup="autoFillNip()" value="<?= $editDataKenaikanJabatan['nip']; ?>">
                                    <small style="color: red;">* Isi sesuai nip anda</small>
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="inputEmail4">Nama</label>
                                    <input type="text" class="form-control nama" id="nama" required name="nama" readonly value="<?= $editDataKenaikanJabatan['nama']; ?>">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    <label for="inputAddress2">SK Jabatan Fungsional Terakhir</label>
                                ...
                                <div class="form-group col-md-4">
                                    <label for="inputAddress2">SK Pangkat Terakhir</label>
                                    <input type="file" class="form-control" id="inputAddress2" placeholder="Apartment, studio, or floor" name="skPangkatTerakhir">
                                    <small>File dalam bentuk .pdf</small>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="file" class="form-control" id="inputAddress2" placeholder="Apartment, studio, or floor" name="skPns">
                                    <small>File dalam bentuk .pdf</small>
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="inputAddress2">SK Cpns</label>
                                    <input type="file" class="form-control" id="inputAddress2" placeholder="Apartment, studio, or floor" name="skCpns">
                                    <small>File dalam bentuk .pdf</small>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="inputAddress2" name="noIjazah" value="<?= $editDataKenaikanJabatan['no_ijazah']; ?>">
                                    <small>No Ijazah Terakhir</small>
                                </div>
                                <div class="form-group col-md-6">
                            ...
                            <div class="form-group">
                                <label for="inputAddress2">STR</label>
                                <input type="file" class="form-control" id="inputAddress2" placeholder="Apartment, studio, or floor" name="str">
                                <small>File dalam bentuk .pdf</small>
                            </div>
                            <div class="form-group">
                                <label for="inputPassword4">Status</label>
                                <input type="text" class="form-control" id="inputPassword4" name="status" value="<?= $editDataKenaikanJabatan['status']; ?>" readonly>
                            </div>

                            <div class="form-group">
                                <label for="inputPassword4">Tanggal Pengajuan</label>
                                <input type="date" class="form-control" id="inputPassword4" name="tanggalPengajuan" value="<?= $editDataKenaikanJabatan['tanggal_pengajuan']; ?>">
                            </div>
                            ...
                            <button type="submit" name="editkenaikanJabatan" class="btn btn-primary mr-2"><i class="fas fa-edit"></i> Ajukan</button>
