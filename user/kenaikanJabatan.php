        ...
        echo "<script>
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    document.location.href = 'kenaikanJabatan.php';
                }
            })
        });
        </script>
...
if (isset($_POST['kenaikanJabatan'])) {
    if (tambahKenaikanJabatan($_POST, $_FILES) > 0) {
        echo "<script>
            $(document).ready(function(){
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Pengusulan kenaikan jabatan fungsional</h1>
                    </div>
                    ...
                    <div class="card mb-3">
                        <form method="post" class="col-12 mt-3 shadow p-3 rounded" enctype="multipart/form-data">
                            ...
                            <button type="submit" name="kenaikanJabatan" class="btn btn-primary mr-2"><i class="fas fa-share-square"></i> Ajukan</button>
