...
$tablePengangkatanPertama = showTablePengangkatanPertama("SELECT * FROM tb_pengangkatan_pertama WHERE nip = '$nip'");
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h3 class="h3 mb-0 text-gray-800">Cek status pengangkatan pertama jabatan fungsional</h1>
                    </div>
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($tablePengangkatanPertama as $row) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <!-- edit -->
                                                <a href="editPengangkatanPertama.php?id=<?= $row['id']; ?>" class="btn-sm btn-warning mr-2">
                                                ...
                                                ?>
                                                    <!-- cetak -->
                                                    <a href="cetakPengangkatanPertama.php?id=<?= $row['id']; ?>" class="btn-sm btn-info mr-2">
                                                ...
                                                <!-- hapus -->
                                                <a href="hapusPengangkatanPertama.php?id=<?= $row['id']; ?>" class="btn-sm btn-danger" onclick="javascript: return confirm('Konfirmasi data akan dihapus');">
