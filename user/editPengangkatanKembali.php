        ...
        echo "<script>
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    document.location.href = 'editPengangkatanKembali.php?id=$id';
                }
            })
        });
        </script>
...
if (isset($_POST['editPengangkatanKembali'])) {
    if (editPengangkatanKembali($_POST, $_FILES) > 0) {
        echo "<script>
        $(document).ready(function(){
...
$editDataPengangkatanKembali = editData("SELECT * FROM tb_pengangkatan_kembali WHERE id = '$id'");
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h3 class="h3 mb-0 text-gray-800">Ubah Data <?= $editDataPengangkatanKembali['nama']; ?> Pengusulan Pengangkatan Kembali</h3>
                    </div>

                    <div class="card mb-3">
                        <form method="post" class="col-12 mt-3 shadow p-3 rounded" enctype="multipart/form-data">
                            <input type="hidden" class="form-control" name="id" value="<?= $editDataPengangkatanKembali['id']; ?>" readonly>
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    <label for="inputPassword4">NIP</label>
                                    <input type="text" class="form-control nip" id="nip" required name="nip" onkeyup="autoFillNip()" value="<?= $editDataPengangkatanKembali['nip']; ?>">
                                    <small style="color: red;">* Isi sesuai nip anda</small>
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="inputEmail4">Nama</label>
                                    <input type="text" class="form-control nama" id="nama" required name="nama" readonly value="<?= $editDataPengangkatanKembali['nama']; ?>">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="file" class="form-control" id="inputAddress2" name="skpSetahun" required>
                                    <small>File dalam bentuk .pdf</small>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label for="inputAddress">SK Pengantar</label>
                                    <input type="file" class="form-control" id="inputAddress" placeholder="1234 Main St" name="skPengantar">
                                    <small>File dalam bentuk .pdf</small>
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="inputAddress2">SK Pembebasan</label>
                                    <input type="file" class="form-control" id="inputAddress2" placeholder="Apartment, studio, or floor" name="skPembebasan">
                                    <small>File dalam bentuk .pdf</small>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputAddress2">PAK Terakhir</label>
                                <input type="file" class="form-control" id="inputAddress2" placeholder="Apartment, studio, or floor" name="pakTerakhir">
                                <small>File dalam bentuk .pdf</small>
                            </div>
                            <div class="form-group">
                                <label for="inputCity">SK Pangkat Terakhir</label>
                                <input type="file" class="form-control" id="inputCity" name="skPangkatTerakhir">
                                <small>File dalam bentuk .pdf</small>
                            </div>
                            <div class="form-group">
                                <label for="inputCity">SPMT</label>
                                <input type="file" class="form-control" id="inputCity" name="spmt">
                                <small>File dalam bentuk .pdf</small>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label for="inputCity">SK Mutasi</label>
                                    <input type="file" class="form-control" id="inputCity" name="skMutasi">
                                    <small>File dalam bentuk .pdf</small>
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="inputCity">SK Pemberhentian Tubel</label>
                                    <input type="file" class="form-control" id="inputCity" name="skPemberhentianTubel">
                                    <small>File dalam bentuk .pdf</small>
                                </div>
                            </div>

                            <div class="form-group">
                                <label style="display: none;" for="inputCity">Status</label>
                                <input type="hidden" class="form-control" id="inputCity" name="status" value="Pending">
                            </div>

                            <div class="form-group">
                                <label for="inputCity">Tanggal Pengajuan</label>
                                <input type="date" class="form-control tanggalPengajuan" id="tanggalPengajuan" name="tanggalPengajuan" value="<?= $editDataPengangkatanKembali['tanggal_pengajuan']; ?>" readonly>
                            </div>
                            ...
                            <button type="submit" name="editPengangkatanKembali" class="btn btn-primary mr-2">
                                <i class="fas fa-edit"></i> Ubah Data</button>
