        ...
        echo "<script>
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    document.location.href = 'editInpassing.php?id=$id';
                }
            })
        });
        </script>
...
if (isset($_POST['editInpassing'])) {
    if (editInpassing($_POST, $_FILES) > 0) {
        echo "<script>
        $(document).ready(function(){
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                document.location.href = 'showInpassing.php';
            }
        })
    });
    </script>";
...
$editDataInpassing = editData("SELECT * FROM tb_inpassing WHERE id = '$id'");
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Edit data <?= $editDataInpassing['nama']; ?> inpassing jabatan fungsional</h1>
                    </div>

                    <div class="card mb-3">
                        <form method="post" class="col-12 mt-3 shadow p-3 rounded" enctype="multipart/form-data">
                            <div class="form-row">
                                <input type="hidden" name="id" value="<?= $editDataInpassing['id']; ?>">
                                <div class="form-group col-md-4">
                                    <label for="inputPassword4">NIP</label>
                                    <input type="text" class="form-control nip" id="nip" name="nip" required value="<?= $editDataInpassing['nip']; ?>" onkeyup="autoFillNip()">
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="inputEmail4">Nama</label>
                                    <input type="text" class="form-control nama" id="nama" name="nama" required value="<?= $editDataInpassing['nama']; ?>" readonly>
                            ...
                            <div class="form-group">
                                <label for="inputAddress">Surat Pengantar Inpassing</label>
                                <input type="file" class="form-control" id="inputAddress" placeholder="1234 Main St" name="skPengantarInpassing">
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control" id="inputAddress2" placeholder="Apartment, studio, or floor" name="spmt">
                                <small>File dalam bentuk .pdf</small>
                            </div>
                            <div class="form-group">
                                <label for="inputPassword4">Status</label>
                                <input type="text" class="form-control" id="inputPassword4" value="<?= $editDataInpassing['status']; ?>" name="status" readonly>
                            </div>

                            <div class="form-group">
                                <label for="inputPassword4">Tanggal Pengajuan</label>
                                <input type="date" class="form-control" id="inputPassword4" value="<?= $editDataInpassing['tanggal_pengajuan']; ?>" name="tanggalPengajuan">
                            </div>
                            ...
                            <button type="submit" name="editInpassing" class="btn btn-primary mr-2"> <i class="fas fa-edit"></i> Ajukan</button>
