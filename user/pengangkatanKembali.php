...
if (isset($_POST['gantiPasswordUser'])) {
    if (gantiPasswordUser($_POST, $_FILES) > 0) {
        echo "<script>
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    document.location.href = 'pengangkatanKembali.php';
                }
            })
        });
        </script>
...
if (isset($_POST['pengajuanKembali'])) {
    if (tambahPengangkatanKembali($_POST) > 0) {
        echo "<script>
            $(document).ready(function(){
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Pengusulan Pengangkatan Kembali</h1>
                    </div>
                    ...
                    <div class="card mb-3">
                        <form method="post" class="col-12 mt-3 shadow p-3 rounded" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control tanggalPengajuan" id="tanggalPengajuan" name="tanggalPengajuan">
                            </div>
                            ...
                            <button type="submit" name="pengajuanKembali" class="btn btn-primary mr-2">
                                <i class="fas fa-share-square"></i> Ajukan</button>
