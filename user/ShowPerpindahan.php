...
$tablePerpindahan = showTablePerpindahan("SELECT * FROM tb_perpindahan WHERE nip = '$nip'");
                    ...
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            <table id="mytable" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    <?php $i = 1; ?>
                                    <?php foreach ($tablePerpindahan as $row) : ?>
                                        <tr>
                                            <td><?= $i ?></td>
                                            <td><?= $row['nama']; ?></td>
                                            <td><?= $row['nip']; ?></td>
                                            ...
                                            <td>
                                                <!-- edit -->
                                                <a href="editPerpindahan.php?id=<?= $row['id']; ?>" class="btn-sm btn-warning mr-2">
                                                ...
                                                ?>
                                                    <!-- cetak -->
                                                    <a href="cetakPerpindahan.php?id=<?= $row['id']; ?>" class="btn-sm btn-info mr-2">
                                                ...
                                                ?>
                                                <!-- hapus -->
                                                <a href="hapusPerpindahan.php?id=<?= $row['id']; ?>" class="btn-sm btn-danger" onclick="javascript: return confirm('Konfirmasi data akan dihapus');">
