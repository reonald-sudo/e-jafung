        ...
        echo "<script>
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    document.location.href = 'editPerpindahan.php?id=$id';
                }
            })
        });
        </script>
...
if (isset($_POST['editPerpindahan'])) {
    if (editPerpindahan($_POST, $_FILES) > 0) {
        echo "<script>
        $(document).ready(function(){
...
$editDataPerpindahan = editData("SELECT * FROM tb_perpindahan WHERE id = '$id'");
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Edit data <?= $editDataPerpindahan['nama']; ?> perpindahan jabatan fungsional</h1>
                    </div>

                    <div class="card mb-3">
                        <form method="post" class="col-12 mt-3 shadow p-3 rounded" enctype="multipart/form-data">
                            <div class="form-row">
                                <input type="hidden" name="id" value="<?= $editDataPerpindahan['id']; ?>">
                                <div class="form-group col-md-4">
                                    <label for="inputPassword4">NIP</label>
                                    <input type="text" class="form-control nip" id="nip" name="nip" required value="<?= $editDataPerpindahan['nip']; ?>" onkeyup="autoFillNip()">
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="inputEmail4">Nama</label>
                                    <input type="text" class="form-control nama" id="nama" name="nama" required value="<?= $editDataPerpindahan['nama']; ?>" readonly>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="inputPassword4" value="<?= $editDataPerpindahan['status']; ?>" name="status" readonly>
                            </div>

                            <div class="form-group">
                                <label for="inputPassword4">Tanggal Pengajuan</label>
                                <input type="date" class="form-control" id="inputPassword4" value="<?= $editDataPerpindahan['tanggal_pengajuan']; ?>" name="tanggalPengajuan">
                            </div>
                            ...
                            <button type="submit" name="editPerpindahan" class="btn btn-primary mr-2"><i class="fas fa-edit"></i> Ajukan</button>
