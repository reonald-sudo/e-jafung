        ...
        echo "<script>
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    document.location.href = 'editPengangkatanPertama.php?id=$id';
                }
            })
        });
        </script>
...
if (isset($_POST['editPengangkatanPertamaa'])) {
    if (editPengangkatanPertama($_POST, $_FILES) > 0) {
        echo "<script>
        $(document).ready(function(){
...
if (isset($_POST['editPengangkatanPertama'])) {
    if (editPengangkatanPertama($_POST) > 0) {
        echo "<script>
        $(document).ready(function(){
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                document.location.href = 'showPengangkatanPertama.php';
            }
        })
    });
    </script>";
...
$editDataPengangkatanPertama = editData("SELECT * FROM tb_pengangkatan_pertama WHERE id = '$id'");
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h3 class="h3 mb-0 text-gray-800">Edit data <?= $editDataPengangkatanPertama['nama']; ?> pengusulan pengangkatan pertama jabatan fungsional</h3>
                    </div>

                    <div class="card mb-3">
                        <form method="post" class="col-12 mt-3 shadow p-3 rounded" enctype="multipart/form-data">
                            <div class="form-row">
                                <input type="hidden" name="id" value="<?= $editDataPengangkatanPertama['id']; ?>">
                                <div class="form-group col-md-4">
                                    <label for="inputPassword4">NIP</label>
                                    <input type="text" class="form-control nip" id="nip" name="nip" required value="<?= $editDataPengangkatanPertama['nip']; ?>" onkeyup="autoFillNip()">
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="inputEmail4">Nama</label>
                                    <input type="text" class="form-control nama" id="nama" name="nama" required value="<?= $editDataPengangkatanPertama['nama']; ?>" readonly>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label for="inputEmail4">No Ijazah</label>
                                    <input type="text" class="form-control" id="inputEmail4" name="noIjazah" required value="<?= $editDataPengangkatanPertama['no_ijazah']; ?>">
                                    <small>No ijazah terbaru</small>
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="inputPassword4">File Ijazah</label>
                                    <input type="file" class="form-control" id="inputPassword4" name="fileIjazah" required>
                                    <small>File dalam bentuk .pdf</small>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputEmail4">Surat Pengantar</label>
                                <input type="file" class="form-control" id="inputEmail4" name="skPengantar" required>
                                <small>File dalam bentuk .pdf</small>
                            </div>
                            <div class="form-group">
                                <label for="inputEmail4">SKP 1 Tahun Terakhir</label>
                                <input type="file" class="form-control" id="inputEmail4" name="skpSetahun" required>
                                <small>File dalam bentuk .pdf</small>
                            </div>
                            <div class="form-group">
                                <label for="inputAddress">SK CPNS</label>
                                <input type="file" class="form-control" id="inputAddress" name="skCpns" placeholder="1234 Main St" required>
                                <small>File dalam bentuk .pdf</small>
                            </div>
                            <div class="form-group">
                                <label for="inputAddress2">SK PNS</label>
                                <input type="file" class="form-control" id="inputAddress2" placeholder="Apartment, studio, or floor" name="skPns" required>
                                <small>File dalam bentuk .pdf</small>
                            </div>
                            <div class="form-group">
                                <label for="inputAddress2">SPMT</label>
                                <input type="file" class="form-control" id="inputAddress2" placeholder="Apartment, studio, or floor" name="spmt" required>
                                <small>File dalam bentuk .pdf</small>
                            </div>

                            <label>
                                <h6 style="color: red;">*Dokumen Penunjang Lain</h6>
                            </label>

                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    <label for="inputCity">STR</label>
                                    <input type="file" class="form-control" id="inputCity" name="str">
                                    <small>File dalam bentuk .pdf</small>
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="inputCity">Sertifikat Diklat</label>
                                    <input type="file" class="form-control" id="inputCity" name="sertiDiklat">
                                    <small>File dalam bentuk .pdf</small>
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="inputZip">Ujikom</label>
                                    <input type="file" class="form-control" id="inputZip" name="ujikom">
                                    <small>File dalam bentuk .pdf</small>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" id="inputPassword4" value="<?= $editDataPengangkatanPertama['status']; ?>" name="status" readonly>
                            </div>

                            <div class="form-group">
                                <label for="inputPassword4">Tanggal Pengajuan</label>
                                <input type="date" class="form-control" id="inputPassword4" value="<?= $editDataPengangkatanPertama['tanggal_pengajuan']; ?>" name="tanggalPengajuan">
                            </div>
                            ...
                            <button type="submit" name="editPengangkatanPertama" class="btn btn-primary mr-2"><i class="fas fa-edit"></i> Ubah Data</button>
