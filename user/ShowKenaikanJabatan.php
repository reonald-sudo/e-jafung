...
$tableKenaikanJabatan = showTableKenaikanJabatan("SELECT * FROM tb_kenaikan_jabatan WHERE nip = '$nip'");
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Cek status pengajuan kenaikan jabatan fungsional</h1>
                    </div>
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($tableKenaikanJabatan as $row) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <!-- edit -->
                                                <a href="EditKenaikanJabatan.php?id=<?= $row['id']; ?>" class="btn-sm btn-warning mr-2">
                                                ...
                                                ?>
                                                    <!-- cetak -->
                                                    <a href="cetakKenaikanJabatan.php?id=<?= $row['id']; ?>" class="btn-sm btn-info mr-2">
                                                ...
                                                ?>
                                                <!-- hapus -->
                                                <a href="hapusKenaikanJabatan.php?id=<?= $row['id']; ?>" class="btn-sm btn-danger" onclick="javascript: return confirm('Konfirmasi data akan dihapus');">
