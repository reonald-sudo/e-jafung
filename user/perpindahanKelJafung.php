...
if (isset($_POST['perpindahanKelJafung'])) {
    if (tambahPerpindahanKelJafung($_POST, $_FILES) > 0) {
        echo "<script>
            $(document).ready(function(){
                ...
                <div class="container-fluid">
                    ...
                    <div class="card mb-3">
                        <form method="post" class="col-12 mt-3 shadow p-3 rounded" enctype="multipart/form-data">
                            ...
                            <button type="submit" name="perpindahanKelJafung" class="btn btn-primary mr-2"><i class="fas fa-share-square"></i> Ajukan</button>
