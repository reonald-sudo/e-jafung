...
$tablePengangkatanKembali = showTablePengangkatanKembali("SELECT * FROM tb_pengangkatan_kembali WHERE nip = '$nip'");
        ...
        echo "<script>
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    document.location.href = 'ShowPengangkatanKembali.php';
                }
            })
        });
        </script>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h3 class="h3 mb-0 text-gray-800">Cek status pengajuan pengangkatan kembali jabatan fungsional</h3>
                    </div>
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($tablePengangkatanKembali as $row) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <!-- edit -->
                                                <a href="editPengangkatanKembali.php?id=<?= $row['id']; ?>" class="btn-sm btn-warning mr-2">
                                                ...
                                                ?>
                                                    <!-- cetak -->
                                                    <a href="cetakPengangkatanKembali.php?id=<?= $row['id']; ?>" class="btn-sm btn-info mr-2">
                                                ...
                                                ?>
                                                <!-- hapus -->
                                                <a href="hapusPengangkatanKembali.php?id=<?= $row['id']; ?>" class="btn-sm btn-danger" onclick="javascript: return confirm('Konfirmasi data akan dihapus');">
