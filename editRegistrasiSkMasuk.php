...
if (isset($_POST['editRegistrasiSkMasuk'])) {
    if (editRegistrasiSkMasuk($_POST) > 0) {
        echo "<script>
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    document.location.href = 'tableRegistrasiSkMasuk.php';
                }
            })
        });
        </script>
...
$id = $_GET['id'];
$tableRegistrasiSkMasuk = editData("SELECT * FROM tb_sk_masuk WHERE id = '$id'");
    ...
    if (gantiPasswordUser($_POST) > 0) {
        echo "<script>
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    document.location.href = 'editRegistrasiSkMasuk.php?id=$id';
                }
            })
        });
        </script>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Edit Data Registrasi SK Masuk</h1>
                    </div>

                    <div class="card shadow">
                        <div class="card-header" style="background-color: #fff;">
                            <a href="tableRegistrasiSkMasuk.php" class="btn btn-primary btn-sm float-left">
                        ...
                        <div class="card-body">
                            <form action="" method="post" enctype="multipart/form-data">
                                <div class="row">
                                    <input type="hidden" name="id" value="<?= $tableRegistrasiSkMasuk['id']; ?>">
                                    <div class="form-group col-lg-6">
                                        <label for="inputAddress2">Nama</label>
                                        <input type="text" class="form-control" id="inputAddress2" name="nama" value="<?= $tableRegistrasiSkMasuk['nama']; ?>">
                                        <small>Beserta Gelar</small>
                                    </div>
                                    <div class="form-group col-lg-6">
                                        <label for="inputAddress2">Nip</label>
                                        <input type="text" class="form-control" id="inputAddress2" name="nip" value="<?= $tableRegistrasiSkMasuk['nip']; ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" id="inputAddress2" name="tanggalMasuk" value="<?= $tableRegistrasiSkMasuk['tanggal_masuk']; ?>">
                                </div>
                                <button type="submit" name="editRegistrasiSkMasuk" class="btn btn-success float-right">Tambah</button>
                            </form>
                        </div>
                    </div>
