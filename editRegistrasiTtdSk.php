...
if (isset($_POST['editRegistrasiTtdSk'])) {
    if (editRegistrasiTtdSk($_POST, $_FILES) > 0) {
        echo "<script>
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    document.location.href = 'tableRegistrasiTtdSk.php';
                }
            })
        });
        </script>
...
$id = $_GET['id'];
$tableRegistrasiTtdSk = editData("SELECT * FROM tb_registrasi_ttd_sk WHERE id = '$id'");
    ...
    if (gantiPasswordUser($_POST) > 0) {
        echo "<script>
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    document.location.href = 'editRegistrasiTtdSk.php?id=$id';
                }
            })
        });
        </script>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Edit Data Registrasi TTD SK</h1>
                    </div>

                    <div class="card shadow">
                        <div class="card-header" style="background-color: #fff;">
                            <a href="tableRegistrasiTtdSk.php" class="btn btn-primary btn-sm float-left">
                        ...
                        <div class="card-body">
                            <form action="" method="post" enctype="multipart/form-data">
                                <div class="row">
                                    <input type="hidden" name="id" value="<?= $tableRegistrasiTtdSk['id']; ?>">
                                    <div class="form-group col-lg-4">
                                        <label for="inputAddress2">Nip</label>
                                        <input type="text" class="form-control" id="inputAddress2" name="nip" value="<?= $tableRegistrasiTtdSk['nip']; ?>" readonly>
                                        <small style="color: red;">* Isi sesuai nip anda</small>
                                    </div>
                                    <div class="form-group col-lg-4">
                                        <label for="inputAddress2">Nama</label>
                                        <input type="text" class="form-control" id="inputAddress2" name="nama" value="<?= $tableRegistrasiTtdSk['nama']; ?>" readonly>
                                        <small>Beserta Gelar</small>
                                    </div>
                                    <div class="form-group col-lg-4">
                                        <label for="inputAddress2">Golongan</label>
                                        <input type="text" class="form-control" id="inputAddress2" name="golongan" value="<?= $tableRegistrasiTtdSk['golongan']; ?>" readonly>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="inputAddress2">SK PPK</label>
                                    <input type="File" class="form-control" id="inputAddress2" name="skPpk">
                                ...
                                <div class="form-group">
                                    <label for="inputAddress2">Tanggal Diupload</label>
                                    <input type="date" class="form-control" id="inputAddress2" name="tanggalDiUpload" value="<?= $tableRegistrasiTtdSk['tanggal_pengajuan']; ?>">
                                </div>
                                <button type="submit" name="editRegistrasiTtdSk" class="btn btn-success float-right">Tambah</button>
                            </form>
                        </div>
                    </div>
