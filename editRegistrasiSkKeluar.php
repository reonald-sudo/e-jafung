...
if (isset($_POST['editRegistrasiSkKeluar'])) {
    if (editRegistrasiSkKeluar($_POST) > 0) {
        echo "<script>
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    document.location.href = 'tableRegistrasiSkKeluar.php';
                }
            })
        });
        </script>
...
$id = $_GET['id'];
$tableRegistrasiSkKeluar = editData("SELECT * FROM tb_sk_keluar WHERE id = '$id'");
    ...
    if (gantiPasswordUser($_POST) > 0) {
        echo "<script>
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    document.location.href = 'editRegistrasiSkKeluar.php?id=$id';
                }
            })
        });
        </script>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Edit Data Registrasi SK Keluar</h1>
                    </div>

                    <div class="card shadow">
                        <div class="card-header" style="background-color: #fff;">
                            <a href="tableRegistrasiSkKeluar.php" class="btn btn-primary btn-sm float-left">
                        ...
                        <div class="card-body">
                            <form action="" method="post" enctype="multipart/form-data">
                                <div class="row">
                                    <input type="hidden" name="id" value="<?= $tableRegistrasiSkKeluar['id']; ?>">
                                    <div class="form-group col-lg-6">
                                        <label for="inputAddress2">Nip</label>
                                        <input type="text" class="form-control" id="inputAddress2" name="nip" value="<?= $tableRegistrasiSkKeluar['nip']; ?>" readonly>
                                        <small style="color: red;">*Isi sesuai nip anda</small>
                                    </div>
                                    <div class="form-group col-lg-6">
                                        <label for="inputAddress2">Nama</label>
                                        <input type="text" class="form-control" id="inputAddress2" name="nama" value="<?= $tableRegistrasiSkKeluar['nama']; ?>" readonly>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="status" name="status">
                                        ...
                                        <option value="Selesai Di Proses">Selesai Di Proses</option>
                                        <option value="Belum Selesai Di Proses">Belum Selesai Di Proses</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label for="inputAddress2">Tanggal Keluar</label>
                                    <input type="date" class="form-control" id="inputAddress2" name="tanggalKeluar" value="<?= $tableRegistrasiSkKeluar['tanggal_keluar']; ?>">
                                </div>
                                <button type="submit" name="editRegistrasiSkKeluar" class="btn btn-success float-right">Simpan</button>
                            </form>
                        </div>
                    </div>
