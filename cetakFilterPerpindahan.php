...
$cetakFilterPerpindahan = showCetakFilterPerpindahan("SELECT * FROM " . 'tb_perpindahan' . " WHERE " . "tanggal_pengajuan >= " . "'" .  $dariTanggal . "'" . ' AND ' . 'tanggal_pengajuan <= ' . "'" . $sampaiTanggal . "'");
...
<body onload="window.print()">
    ...
    <br>
    <h4 class="tengah hitam">CETAK DATA PENGAJUAN PERPINDAHAN</h4>
    <br>
