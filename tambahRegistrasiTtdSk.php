...
if (isset($_POST['tambahRegistrasiTtdSk'])) {
    if (tambahRegistrasiTtdSk($_POST, $_FILES) > 0) {
        echo "<script>
    ...
    if (gantiPasswordUser($_POST) > 0) {
        echo "<script>
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    document.location.href = 'tambahRegistrasiTtdSk.php';
                }
            })
        });
        </script>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Tambah Data Registrasi TTD SK</h1>
                    </div>
                            ...
                            <form action="" method="post" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="form-group col-lg-4">
                                        ...
                                        <input type="text" class="form-control nip" id="nip" name="nip" onkeyup="autoFillNip()">
                                        <small style="color: red;">* Isi sesuai nip anda</small>
                                    </div>
                                    <div class="form-group col-lg-4">
                                        <label for="inputAddress2">Nama</label>
                                        <input type="text" class="form-control nama" id="nama" name="nama" readonly>
                                        <small>Beserta Gelar</small>
                                    </div>
                                    <div class="form-group col-lg-4">
                                        <label for="golongan">Golongan</label>
                                        <input type="text" class="form-control golongan" id="golongan" name="golongan" readonly>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" id="inputAddress2" name="tanggalDiUpload" value="<?= date('Y-m-d'); ?>">
                                </div>
                                <button type="submit" name="tambahRegistrasiTtdSk" class="btn btn-success float-right">Tambah</button>
                            </form>
                        </div>
                    </div>
        ...
        function autoFillNip() {
            $(document).ready(function() {
                ...
                nip.on('keyup', function() {
                    $.get("user/ajax/autoFillPengangkatanKembali.php?nip=" + nip.val(), function(data) {
                        let json = data,
                            obj = JSON.parse(json);
