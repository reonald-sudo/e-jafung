...
$tableKenaikanJabatan = showTableKenaikanJabatan("SELECT * FROM tb_kenaikan_jabatan");

if (isset($_POST['verifikasiKenaikanJabatan'])) {
    if (verifikasiKenaikanJabatan($_POST) > 0) {
        echo "<script>
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    document.location.href = 'tableKenaikanJabatan.php';
                }
            })
        });
        </script>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Verifikasi Tabel Kenaikan Jabatan</h1>
                    </div>
                    ...
                    <div class="card shadow">
                            ...
                            <div class="modal fade" id="cetakFilter" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="cetakFilterKenaikanJabatan.php" method="get" target="_blank">
                        ...
                        <div class="card-body">
                            <table id="mytable" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    <?php $i = 1; ?>
                                    <?php foreach ($tableKenaikanJabatan as $row) : ?>
                                        <tr>
                                            <td><?= $i ?></td>
                                            <td><?= $row['nama']; ?></td>
                                            <td><?= $row['nip']; ?></td>
                                                                ...
                                                                <div>
                                                                    <table class="table table-bordered table-hover">
                                                                        ...
                                                                        <tbody>
                                                                            ...
                                                                            <tr>
                                                                                <!-- SK PNS -->
                                                                                <td>Sk jabatan fungsional akhir</td>
                                                                                <td>
                                                                                    <!-- Button trigger modal -->
                                                                                    <button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#skJafungAkhir<?= $row['id']; ?>">
                                                                                        <i class="far fa-eye"></i> Lihat
                                                                                    </button>

                                                                                    <!-- Modal -->
                                                                                    <div class="modal fade" id="skJafungAkhir<?= $row['id']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                                                        <div class="modal-dialog">
                                                                                            <div class="modal-content">
                                                                                                <div class="modal-header">
                                                                                                    <h5 class="modal-title" id="exampleModalLabel">Sk jabatan fungsional akhir <?= $row['nama']; ?></h5>
                                                                                                </div>
                                                                                                <div class="modal-body modal-xl" id="modal-body">
                                                                                                    <div>
                                                                                                        <iframe src="document/pdf/<?= $row['sk_jabatan_fungsional_terakhir']; ?>" frameborder="0" width="470" height="520"></iframe>
                                                                                                    </div>
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <!-- Button trigger modal -->
                                                                                    <button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#skPangkatAkhir<?= $row['id']; ?>">
                                                                                        <i class="fa fa-eye"></i> Lihat
                                                                                    </button>

                                                                                    <!-- Modal -->
                                                                                    <div class="modal fade" id="skPangkatAkhir<?= $row['id']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                                                        <div class="modal-dialog">
                                                                                            <div class="modal-content">
                                                                                                <div class="modal-header">
                                            ...
                                            <td>
                                                ...
                                                <div class="modal fade" id="verifikasi<?= $row['id']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="exampleModalLabel">Verifkiasi Kenaikan Jabatan <?= $row['nama']; ?></h5>
                                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                    <span aria-hidden="true">&times;</span>
                                                                </button>
                                                            </div>
                                                            <div class="modal-body" id="modal-body">
                                                                <form method="post">
                                                                    ...
                                                                    <button type="submit" class="btn btn-primary col-md-12" name="verifikasiKenaikanJabatan"> Submit</button>
                                                                </form>
                                                            </div>
                                                        </div>
                                                    </div>
