...
if (isset($_POST['tambahTabelPegawai'])) {
    if (tambahPegawai($_POST) > 0) {
        echo "<script>
            $(document).ready(function(){
            Swal.fire({
                title: 'Berhasil Tambah Data Pegawai!',
                icon: 'success',
                            ...
                            <form action="" method="post">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" class="form-control" id="inputPassword4" required name="nama">
                                        <small>Nama Dengan Gelar</small>
                                    </div>
                                    <div class="form-group col-md-4">
                                ...
                                <button class="btn btn-success float-right" type="submit" name="tambahTabelPegawai"> Simpan</button>
                            </form>
