...
if (isset($_POST['tambahRegistrasiSkMasuk'])) {
    if (tambahRegistrasiSkMasuk($_POST) > 0) {
        echo "<script>
    ...
    if (gantiPasswordUser($_POST) > 0) {
        echo "<script>
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    document.location.href = 'tambahRegistrasiSkMasuk.php';
                }
            })
        });
        </script>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Tambah Data Registrasi SK Masuk</h1>
                    </div>
                            ...
                            <form action="" method="post" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="form-group col-lg-6">
                                        ...
                                        <input type="text" class="form-control" id="inputAddress2" name="nama">
                                        <small>Beserta Gelar</small>
                                    </div>
                                    <div class="form-group col-lg-6">
                                        <label for="inputAddress2">Nip</label>
                                        <input type="text" class="form-control" id="inputAddress2" name="nip">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="inputAddress2">Tanggal Masuk</label>
                                    <input type="date" class="form-control" id="inputAddress2" name="tanggalMasuk">
                                </div>
                                <button type="submit" name="tambahRegistrasiSkMasuk" class="btn btn-success float-right">Tambah</button>
                            </form>
                        </div>
                    </div>
