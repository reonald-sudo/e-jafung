...
if (isset($_POST['tambahRegistrasiSkKeluar'])) {
    if (tambahRegistrasiSkKeluar($_POST) > 0) {
        echo "<script>
    ...
    if (gantiPasswordUser($_POST) > 0) {
        echo "<script>
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    document.location.href = 'tambahRegistrasiSkKeluar.php';
                }
            })
        });
        </script>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Tambah Data Registrasi SK Keluar</h1>
                    </div>
                            ...
                            <form action="" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="status" name="status">
                                        ...
                                        <option value="Belum Diterima Yang Bersangkutan">Belum Diterima Yang Bersangkutan</option>
                                        <option value="Sudah Diterima Yang Bersangkutan">Sudah Diterima Yang Bersangkutan</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label for="inputAddress2">Tanggal Keluar</label>
                                    <input type="date" class="form-control" id="inputAddress2" name="tanggalKeluar" value="<?= date('Y-m-d'); ?>">
                                </div>
                                <button type="submit" name="tambahRegistrasiSkKeluar" class="btn btn-success float-right">Tambah</button>
                            </form>
                        </div>
                    </div>
